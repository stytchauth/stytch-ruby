...
module Stytch
  class Discovery
    ...
    attr_reader :discovery, :discovery

    def initialize(connection)
      @connection = connection

      @intermediatesessions = Stytch::Discovery::IntermediateSessions.new(@connection)
      @organizations = Stytch::Discovery::Organizations.new(@connection)
    end
