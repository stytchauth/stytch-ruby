...
module StytchB2B
  class Organizations
    ...
    def create(
      organization_name:, organization_slug:, organization_logo_url:, email_allowed_domains:, allowed_auth_methods:, trusted_metadata: nil, sso_jit_provisioning: nil, email_jit_provisioning: nil, email_invites: nil, auth_methods: nil
    )
      request = {
        organization_name: organization_name, organization_slug: organization_slug, organization_logo_url: organization_logo_url, email_allowed_domains: email_allowed_domains, allowed_auth_methods: allowed_auth_methods,
      }
    ...
    def update(
      organization_id:, organization_name: nil, organization_slug: nil, organization_logo_url: nil, trusted_metadata: nil, sso_default_connection_id: nil, sso_jit_provisioning: nil, sso_jit_provisioning_allowed_connections: nil, email_allowed_domains: nil, email_jit_provisioning: nil, email_invites: nil, auth_methods: nil, allowed_auth_methods: nil
    )
      request = {
        organization_id: organization_id,
      }
    ...
    def member_create(
      organization_id:, email_address:, create_member_as_pending:, is_breakglass:, name: nil, trusted_metadata: nil, untrusted_metadata: nil
    )
      request = {
        organization_id: organization_id, email_address: email_address, create_member_as_pending: create_member_as_pending, is_breakglass: is_breakglass,
      }
    ...
    def member(
      organization_id:, member_id: nil, email_address: nil
    )
      query_params = {
        organization_id: organization_id, member_id: member_id, email_address: email_address,
      }
    ...
    class Members
      ...
      def organizations_update(
        organization_id:, member_id:, name: nil, trusted_metadata: nil, untrusted_metadata: nil, is_breakglass: nil
      )
        request = {
      ...
      def search(
        cursor:, organization_ids:, limit: nil, query: nil
      )
        request = {
          cursor: cursor, organization_ids: organization_ids,
        }
        request[:limit] = limit if limit != nil
        request[:query] = query if query != nil
